...
ActiveRecord::Schema.define(version: 2021_01_08_052245) do
  ...
  create_table "recipe_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["recipe_tag_id"], name: "index_recipe_tag_relations_on_recipe_tag_id"
  end
  ...
  create_table "recipe_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tag"], name: "index_recipe_tags_on_tag", unique: true
  end
  ...
  add_foreign_key "recipe_tag_relations", "recipe_tags"
